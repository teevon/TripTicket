...
<head>
    ...
    <title>TripBook - Book your first class Trips</title>
    <!-- Bootstrap CSS -->
...
<body>
    <input type="hidden" id="vctrId" value="">
            ...
            <div class="container-fluid dashboard-content">
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        ...
                        <!-- ============================================================== -->
                        <div class="card">
                            <h5 class="card-header">Travelling From</h5>
                            <div class="card-body">
                                <div class="list-group terminal-group">
                                    <input id="fromTerminalsSearch" type="text" placeholder="Search..." class="form-control terminals-search">
                                    <a href="#" class="list-group-item list-group-item-action selected-terminal active" data-id="" data-city="" data-state="" data-areaName=""> State (City / Terminal) </a>
                                    <!-- <a href="#" class="list-group-item list-group-item-action">Abia ( )</a>
                                    <a href="#" class="list-group-item list-group-item-action">Delta ( )</a>
                                    <a href="#" class="list-group-item list-group-item-action">Lagos ( )</a>
                                    <a href="#" class="list-group-item list-group-item-action disabled">Ekiti ( )</a> -->
                                </div>
                            </div>
                        </div>
                        <!-- ============================================================== -->
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        ...
                        <!-- ============================================================== -->
                        <div class="card">
                            <h5 class="card-header">Travelling To</h5>
                            <div class="card-body">
                                <div class="list-group terminal-group">
                                    <input id="toTerminalsSearch" type="text" placeholder="Search..." class="form-control terminals-search" disabled>
                                    <a href="#" class="list-group-item list-group-item-action selected-terminal active" data-id="" data-city="" data-state="" data-areaName=""> State (City / Terminal) </a>
                                </div>
                            </div>
                        </div>
